...
<Steps>
  ...
  <div className="container mx-auto my-4">
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <FrameworkCards title="Gatsby" description="Learn about installing and initializing Clerk in a new Gatsby application." link="/docs/quickstarts/gatsby" cta="Get Started" icon="/docs/images/logos/gatsby.svg" iconWidth="40" />
      ...
      <FrameworkCards title="JavaScript" description="Learn about installing and initializing Clerk in a new JavaScript application." link="/docs/quickstarts/javascript" cta="Get Started" icon="/docs/images/logos/javascript.svg" iconWidth="40" />
      ...
      {/* Quickstart guides are not written for these yet

      <FrameworkCards title="Express.js" description="Add authentication and user management to your Express.js application." link="/docs/quickstarts" cta="Coming Soon" hideArrow={true} icon="/docs/images/logos/express.svg" iconWidth="30" />

      <FrameworkCards title="Ruby / Rails" description="Integrate user management and authentication into your Ruby application." link="/docs/quickstarts" cta="Coming Soon" hideArrow={true} icon="/docs/images/logos/ruby.svg" /> 
